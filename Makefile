...
parser: build parse.tab.o lex.yy.o
	${CC} ${CFLAGS} $(COMMON_SRCS) symbol.c table.c ast.c print_ast.c parser_driver.c parse.tab.o lex.yy.o types.c semantics.c env.c ${DEBUG_FLAGS} -o ${BUILD_DIR}/${BUILD_FILE_PARSER_DEBUG}
